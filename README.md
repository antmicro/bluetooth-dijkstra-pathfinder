...
The application is based on [Zephyr RTOS](https://github.com/zephyrproject-rtos) and its BLE stack.<br>
Testing was performed in multinode configurations with [Renode](https://github.com/renode/renode).

The proposed solution is an alternative to the standard BLE mesh, based
on a principle of flooding. The Pathfinding approach is aimed at allowing larger data transfer
