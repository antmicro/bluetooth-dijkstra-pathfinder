...
Get Packet Travel Time
    ...
    Create Terminal Tester     sysbus.uart0     machine=sink
    Start Emulation 
    ...
    Append To File     path=/home/js/Projects/antmicro/bluetooth-dijkstra-pathfinder/tests/out/4nodes.log     content=${travel_time_as_string}
    Append To File     path=/home/js/Projects/antmicro/bluetooth-dijkstra-pathfinder/tests/out/4nodes.log     content=\n
