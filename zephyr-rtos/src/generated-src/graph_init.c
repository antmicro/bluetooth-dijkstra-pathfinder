...
uint8_t graph_init(struct node_t *graph){ 
   // graph mutex initialization 
    ...
    (graph[0].paths + 0)->addr = 0x8;
    (graph[0].paths + 0)->distance = 5;
    
    (graph[0].paths + 1)->addr = 0x9;
    (graph[0].paths + 1)->distance = 3;
    
    (graph[0].paths + 2)->addr = 0x5;
    (graph[0].paths + 2)->distance = 8;
    ...
    (graph[1].paths + 0)->distance = 7;
    
    (graph[1].paths + 1)->addr = 0x7;
    (graph[1].paths + 1)->distance = 10;
    ...
    graph[2].paths_size = 4;
    
    graph[2].paths = k_malloc(sizeof(struct path_t) * graph[2].paths_size);
    if(graph[2].paths == NULL) return 1;
    
    (graph[2].paths + 0)->addr = 0x6;
    (graph[2].paths + 0)->distance = 2;
    
    (graph[2].paths + 1)->addr = 0x4;
    (graph[2].paths + 1)->distance = 2;
    
    (graph[2].paths + 2)->addr = 0x7;
    (graph[2].paths + 2)->distance = 4;
    
    (graph[2].paths + 3)->addr = 0x5;
    (graph[2].paths + 3)->distance = 8;
    ...
    (graph[4].paths + 0)->addr = 0x7;
    (graph[4].paths + 0)->distance = 3;
    
    (graph[4].paths + 1)->addr = 0x2;
    (graph[4].paths + 1)->distance = 5;
    
    (graph[4].paths + 2)->addr = 0x9;
    (graph[4].paths + 2)->distance = 1;
    
    (graph[4].paths + 3)->addr = 0x5;
    (graph[4].paths + 3)->distance = 2;
    ...
    (graph[5].paths + 0)->addr = 0x8;
    (graph[5].paths + 0)->distance = 1;
    
    (graph[5].paths + 1)->addr = 0x0;
    (graph[5].paths + 1)->distance = 8;
    
    (graph[5].paths + 2)->addr = 0x2;
    (graph[5].paths + 2)->distance = 3;
    
    (graph[5].paths + 3)->addr = 0x4;
    (graph[5].paths + 3)->distance = 5;
    ...
    (graph[6].paths + 0)->addr = 0x8;
    (graph[6].paths + 0)->distance = 3;
    
    (graph[6].paths + 1)->addr = 0x7;
    (graph[6].paths + 1)->distance = 8;
    
    (graph[6].paths + 2)->addr = 0x2;
    (graph[6].paths + 2)->distance = 8;
    
    (graph[6].paths + 3)->addr = 0x9;
    (graph[6].paths + 3)->distance = 4;
    ...
    graph[7].paths_size = 5;
    
    graph[7].paths = k_malloc(sizeof(struct path_t) * graph[7].paths_size);
    if(graph[7].paths == NULL) return 1;
    
    (graph[7].paths + 0)->addr = 0x9;
    (graph[7].paths + 0)->distance = 10;
    
    (graph[7].paths + 1)->addr = 0x6;
    (graph[7].paths + 1)->distance = 3;
    
    (graph[7].paths + 2)->addr = 0x1;
    (graph[7].paths + 2)->distance = 4;
    
    (graph[7].paths + 3)->addr = 0x4;
    (graph[7].paths + 3)->distance = 3;
    
    (graph[7].paths + 4)->addr = 0x2;
    (graph[7].paths + 4)->distance = 8;
    ...
    graph[8].paths_size = 5;
    
    graph[8].paths = k_malloc(sizeof(struct path_t) * graph[8].paths_size);
    if(graph[8].paths == NULL) return 1;
    
    (graph[8].paths + 0)->addr = 0x1;
    (graph[8].paths + 0)->distance = 8;
    
    (graph[8].paths + 1)->addr = 0x5;
    (graph[8].paths + 1)->distance = 3;
    
    (graph[8].paths + 2)->addr = 0x0;
    (graph[8].paths + 2)->distance = 9;
    
    (graph[8].paths + 3)->addr = 0x6;
    (graph[8].paths + 3)->distance = 4;
    
    (graph[8].paths + 4)->addr = 0x3;
    (graph[8].paths + 4)->distance = 9;
    ...
    graph[9].paths_size = 4;
    
    graph[9].paths = k_malloc(sizeof(struct path_t) * graph[9].paths_size);
    if(graph[9].paths == NULL) return 1;
    
    (graph[9].paths + 0)->addr = 0x7;
    (graph[9].paths + 0)->distance = 3;
    
    (graph[9].paths + 1)->addr = 0x0;
    (graph[9].paths + 1)->distance = 9;
    
    (graph[9].paths + 2)->addr = 0x4;
    (graph[9].paths + 2)->distance = 3;
    
    (graph[9].paths + 3)->addr = 0x6;
    (graph[9].paths + 3)->distance = 8;
